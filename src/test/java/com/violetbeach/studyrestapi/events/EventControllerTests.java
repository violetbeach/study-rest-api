...
import com.violetbeach.studyrestapi.common.TestDescription;
...
public class EventControllerTests {
    ...
    public void queryEvents() throws Exception {
        // Given
        IntStream.range(0, 30).forEach(this::generateEvent); // method reference
    ...
    public void getEvent404() throws Exception {
        // When & Then
        this.mockMvc.perform(get("/api/events/1101"))
    ...
    public void updateEvent404() throws Exception {
        ...
        // When & Then
        this.mockMvc.perform(put("/api/events/1126131")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound());
